...
AUDIT_ENTRY_DATETIME	DATE NOT NULL,
AUDIT_MODIFIED_DATETIME	DATE NOT NULL
);
...
--drop table META_CUSTOMER_STATUS;
--drop table META_CHECKER_ACTION;
--drop table META_USER_ROLE;
--drop table USERS;
